...
:: Uninstall-FortiClient.cmd - launcher for Uninstall-FortiClient.ps1, which must sit next to this file.
::
...
::
::     Uninstall-FortiClient.cmd -ListOnly
::
...
set "SCRIPT=%~dp0Uninstall-FortiClient.ps1"
if not exist "%SCRIPT%" (
