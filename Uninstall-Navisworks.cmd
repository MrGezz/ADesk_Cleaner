...
:: Uninstall-Navisworks.cmd - launcher for Uninstall-Navisworks.ps1, which must sit next to this file.
::
...
::
::     Uninstall-Navisworks.cmd -ProductYear 2025 -ListOnly
::
...
set "SCRIPT=%~dp0Uninstall-Navisworks.ps1"
if not exist "%SCRIPT%" (
