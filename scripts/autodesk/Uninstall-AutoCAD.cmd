...
:: Uninstall-AutoCAD.cmd - launcher for Uninstall-AutoCAD.ps1, which must sit next to this file.
::
...
::
::     Uninstall-AutoCAD.cmd -ProductYear 2025 -ListOnly
::
...
set "SCRIPT=%~dp0Uninstall-AutoCAD.ps1"
if not exist "%SCRIPT%" (
