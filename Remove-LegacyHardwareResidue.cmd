...
:: Remove-LegacyHardwareResidue.cmd - launcher for Remove-LegacyHardwareResidue.ps1, which must sit next to this file.
::
...
::
::     Remove-LegacyHardwareResidue.cmd -ListOnly
::
...
set "SCRIPT=%~dp0Remove-LegacyHardwareResidue.ps1"
if not exist "%SCRIPT%" (
