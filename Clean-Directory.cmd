...
:: Clean-Directory.cmd - launcher for Clean-Directory.ps1, which must sit next to this file.
::
...
::
::     Clean-Directory.cmd -RootPath "C:\Projects" -WhatIf
::
:: No elevation and no registry access. -WhatIf here is the script own plain
:: switch, and passes through this launcher unchanged.
::
...
set "SCRIPT=%~dp0Clean-Directory.ps1"
if not exist "%SCRIPT%" (
